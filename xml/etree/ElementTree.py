...
# Embedded file name: c:\python33\lib\xml\etree\ElementTree.py
...
class ElementTree:
    ...
    def write(self, file_or_filename, encoding=None, xml_declaration=None, default_namespace=None, method=None):
        ...
        with _get_writer(file_or_filename, encoding) as (write):
            if method == 'xml' and (xml_declaration or xml_declaration is None) and encoding not in ('utf-8',
                                                                                                     'us-ascii',
                                                                                                     'unicode'):
    ...
    def _flush(self):
        if self._data:
            if self._last is not None:
                ...
                elif not self._last.text is None:
